...
- **Registrar gasto:** resta unidades y permite indicar una matrícula opcional. Solo admite repuestos y consumibles (las herramientas no se "gastan").
  - En aceite, anticongelante, líquido de frenos, limpiaparabrisas, disolvente, agua destilada, pulimento y WD40 (los que llevan envase), primero se descuenta de lo que ya está abierto y, si no llega, se abre lo que haga falta de Cantidad. El contador "Abierto" nunca pasa de 1: indica si hay o no un envase en uso ahora mismo.
...
- **Repuestos por pedir:** solo avisa de repuestos nuevos cuando quedan 0 o 1 unidades. Los dañados, de desguace y protectores laterales no generan avisos ni peticiones.
